  ...
  <Container>
    ...
    <LargeContainerFlex>
      ...
      <InfoItemContainer className='attributionsContainer'>
        ...
        >
          <StyledTypography>Freepik - Imágen por wirestock</StyledTypography>
        </FooterLink>
        <FooterLink
          target='_blank'
          rel='noreferrer'
      ...
      <InfoItemContainer className='attributionsContainer'>
        ...
        >
          <StyledTypography>Freepik - Imágen por master1305</StyledTypography>
        </FooterLink>
      ...
      <InfoItemContainer className='attributionsContainer'>
        ...
        >
          <StyledTypography>Freepik - Imágen por gpointstudio</StyledTypography>
        </FooterLink>
        <FooterLink
          target='_blank'
          rel='noreferrer'
        ...
        >
          <StyledTypography>Freepik - Imágen por prostooleh</StyledTypography>
        </FooterLink>
        <FooterLink
          target='_blank'
          rel='noreferrer'
